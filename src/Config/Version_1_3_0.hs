...
-- ~\~ begin <<lit/04-configuration.md|src/Config/Version_1_3_0.hs>>[init]
...
-- ~\~ begin <<lit/04-configuration.md|config-1-3-0-record>>[init]
data Config = Config
    { configVersion   :: Text
...
-- ~\~ end
-- ~\~ begin <<lit/04-configuration.md|config-1-3-0-decoder>>[init]
